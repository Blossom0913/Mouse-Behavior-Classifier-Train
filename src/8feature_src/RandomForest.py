"""
Random Forest Classifier for Mouse Behavior Classification
"""
import numpy as np
...
def save_model(model, scaler, experiment_type):
    ...
    model_name = f"random_forest_{experiment_type}_{timestamp}.pkl"
...
def run_experiment(X_raw, y_raw, num_classes=4, include_base=True, 
    ...
    """
    Run Random Forest experiment with stratified splitting
...
def main():
    ...
    for include_base, num_classes in [(True, 4), (False, 3)]:
        ...
        print(f"\n=== STARTING Random Forest {exp_type.upper()} EXPERIMENT ===")
